...
<!-- Navigation -->
<?php
  $getUser = Session::get('userDetails');
?>
  ...
  <div class="container-fluid">
    ...
    <div class="row" style="width:250%;">
      <div class="col-md-4 col-md-offset-4">
        <form class="form-horizontal" role="form" method="post" action="{{URL('/shopin')}}">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="textinput">Pan No</label>
              <div class="col-sm-10">
                <input type="text" placeholder="Pan No" class="form-control" name="pan" value="@if(isset($getUser)){{$getUser->pan}}@endif">
              </div>
            </div>
            <div class="form-group">
